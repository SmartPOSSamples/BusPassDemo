...
public class ScanParameter implements Parcelable {
	...
	public static final String KEY_ENABLE_MOTION_ILLUMINATION_BY_HANDSFREE = "enable_motion_illumination";// true
	...
	public static final String KEY_ENABLE_FRAME_RATE_MODE = "frame_rate_mode";
	public static final String KEY_ENABLE_SOUND = "enable_sound";// true : enable sound for decode bar(default); false: disable sound for decode bar.
